...
const Hero = () => {
  return (
    <div className="h-[95vh] md:h-[100vh] relative w-full overflow-hidden">
      ...
      />
      <div
        className="flex pb-36 pt-24 md:pb-24 md:pt-24 px-4 md:px-20 md:justify-between h-full items-center md:items-start flex-col-reverse md:flex-col opacity-0 animate-in"
